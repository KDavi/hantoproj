...
public class OppositeColorPlacement {
	...
	public void test2() {
		...
		try {
			...
			result = game.makeMove(HantoPieceType.BUTTERFLY, null, new BasicCoordinate(0, 1));
			assertEquals(MoveResult.OK, result);
			result = game.makeMove(HantoPieceType.SPARROW, null, new BasicCoordinate(1, 1));
			fail("should have gotten exception");
	...
	public void test3() {
		...
		try {
			...
			result = game.makeMove(HantoPieceType.BUTTERFLY, null, new BasicCoordinate(0, 1));
			assertEquals(MoveResult.OK, result);
			result = game.makeMove(HantoPieceType.SPARROW, null, new BasicCoordinate(0, 2));
			fail("should have gotten exception");
	...
	public void test4() {
		...
		try {
			...
			result = game.makeMove(HantoPieceType.BUTTERFLY, null, new BasicCoordinate(0, 1));
			assertEquals(MoveResult.OK, result);
			result = game.makeMove(HantoPieceType.SPARROW, null, new BasicCoordinate(-1, 2));
			fail("should have gotten exception");
